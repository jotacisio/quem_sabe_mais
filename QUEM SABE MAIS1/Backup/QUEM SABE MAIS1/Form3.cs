    ...
    public partial class Form3 : Form
    {
        ...
        public void verResposta()
        {
            if (RBA.Text == respostaC && RBA.Checked == true)
            {
                ...
                SoundPlayer IniciarPlayer = new SoundPlayer(@"G:\Arquivos de música.wav\aplauso.wav");
                IniciarPlayer.Play();
                MessageBox.Show("Alternativa Correta", "Parabéns", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                //Mudar para o local do arquivo de som
                SoundPlayer IniciarPlayer = new SoundPlayer(@"G:\Arquivos de música.wav\Boo.wav");
                IniciarPlayer.Play();
